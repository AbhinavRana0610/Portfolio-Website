    ...
    <section id="projects" className="section-padding noise-bg">
      <div className="container-custom">
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-4xl md:text-5xl font-black mb-4">Featured <span className="text-maroon">Projects.</span></h2>
        ...
        <div className="grid grid-cols-1 gap-24">
          {projects.map((project, idx) => (
            ...
            >
              <div className="w-full lg:w-3/5 overflow-hidden rounded-3xl shadow-2xl relative bg-black/5">
                <motion.div
                ...
                <div className="absolute inset-0 bg-maroon/20 mix-blend-overlay opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>

              <div className="w-full lg:w-2/5">
                <div className="flex gap-4 mb-6">
                  {project.tech.map((t) => (
                    <span key={t} className="text-[10px] font-black uppercase tracking-[0.2em] text-teal border border-teal/30 px-3 py-1 rounded-full bg-teal/5">
                      {t}
                    </span>
                  ))}
                </div>
                <h3 className="text-3xl md:text-4xl font-black mb-6 group-hover:text-maroon transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex gap-6">
                  <a 
                    ...
                    className="flex items-center gap-2 font-bold text-sm uppercase tracking-widest hover:text-gold transition-colors"
                  >
